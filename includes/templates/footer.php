<footer class="site-footer">
  <div class="contenedor clearfix">
    ...
    <div class="ultimos-tweets">
      ...
      <a class="twitter-timeline" data-height="400" data-theme="light" data-link-color="#fe4918" href="https://twitter.com/abernaolao">Tweets by LekandaNet</a>
  ...
  <style type="text/css">
    ...
    <div style="display:none;">
      <div id="mc_embed_signup">
        <form action="https://gmail.us5.list-manage.com/subscribe/post?u=18c3f637667a4a88d98e0463d&amp;id=b964b23576" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
          <div id="mc_embed_signup_scroll">
            ...
            <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_18c3f637667a4a88d98e0463d_b964b23576" tabindex="-1" value=""></div>
...
<script src="/GDLwebcampPHP/js/vendor/modernizr-3.8.0.min.js"></script>
<script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
<script>
  window.jQuery || document.write('<script src="js/vendor/jquery-3.4.1.min.js"><\/script>')
</script>
<script src="/GDLwebcampPHP/js/plugins.js"></script>
<script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"></script>

<script src="/GDLwebcampPHP/js/main.js"></script>
<script src="/GDLwebcampPHP/js/jquery.animateNumber.min.js"></script>
